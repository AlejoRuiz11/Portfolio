...
export const projects = [
  ...
  },
  {
    ...
    longDesc:  'Built as a real-time concurrent system. Multiple independent threads drive simultaneous sensory distraction effects - audio triggers, visual interrupts, focus-loss events - without blocking the main render loop. An event-driven architecture connects the cognitive simulation subsystems: each distraction type is an independent event producer; the player experience layer is the consumer.',
  ...
  },
  {
    ...
    longDesc:  'A complete barbershop management platform with two distinct data layers. The Spring Boot backend exposes a RESTful API following strict MVC architecture with a service layer that orchestrates business logic and a repository layer that abstracts all data access. Firebase Firestore handles the real-time queue state - when a barber updates a turn, all connected clients see the change instantly without polling. Firebase Auth manages the authentication flow for both clients and barbers.\n\nThe React frontend consumes the Spring Boot API for appointments and product catalog management, while subscribing to Firestore listeners for live queue updates. REST for transactional operations, Firestore for event-driven state - each layer clean and independently scalable.',
  ...
  },
  {
    ...
    longDesc:  'A complete small-scale e-commerce system in Laravel. Implements the full MVC stack: Blade views, Eloquent models with relationship definitions, and controller-level request handling. Features user authentication, product catalog, and shopping cart.',
...
export const adaptability = [
  { icon: '\u{1F30D}', text: 'Studied across three countries - Colombia, Argentina, and Austria - comfortable in multicultural and multilingual academic settings.' },
  { icon: '\u{1F1EC}\u{1F1E7}', text: 'Coursework at Montanuniversitat Leoben fully conducted in English; research and technical reading done primarily in English.' },
  { icon: '\u{1F91D}', text: 'Experienced coordinating software development in international university team projects with cross-cultural collaboration.' },
  ...
  { icon: '\u{1F9ED}', text: 'Adaptable, team-oriented, and genuinely curious toward different perspectives and ways of working.' },
]
